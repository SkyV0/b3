    ...
    <>
      ...
      <div className="min-h-screen flex flex-col items-stretch">
              <Navbar />
                     ...
                     <div className="bg-white w-full max-w-[1000px] border-black border-r border border-l-4 text-black px-12" role="alert">
  <p className="font-bold">Please notice.</p>
  <p>This is a paid post, and not everyone will win, but everyone will have the same chance to Just B3!</p>
                  </div>
                  </div>
        <div className="flex justify-center mx-2 flex-grow bg-gray-1">
                  <div className="w-full max-w-[1000px] p-8 bg-white my-4">
               
            <h1 className="text-2xl font-bold">Are you ready to Just B3?</h1>
                      <p className="text-gray-400 mt-2">Post a video to your account and B3 Known.</p>
                      <p className="text-violet mt-2">The most B3Loved post will win the total collected during the buyin period.</p>
                      <p className="text-black mt-2">All because you decided to Just B3 You!</p>
            <div className="flex items-start mt-10 gap-4">
              {videoURL ? (
                ...
                >
                  ...
                  <div className="w-full bg-violet text-white p-2">
                    Select file
                  </div>
                </button>
              )}
